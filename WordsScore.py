...
"""
    ...
    9
    Explanation
    The score of "hello" is 1 (2 vowels), the score of "world" is 2 (1 vowel), the score of "hackerrank" is 1 (3 vowels), and the score of "python" is 2 (1 vowel). Therefore, the total score is 1 + 2 + 1 + 2 = 6.
...
def word_score(words):
    ...
    Complexity: O(N*M) where N is the number of words and M is the average length of the words, since we are iterating through each word and counting the number of vowels in each word.
    """
    score = 0
    pattern = r"(?i)([aeiouy])"
    for word in words:
